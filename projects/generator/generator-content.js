  ...
  global.GENERATOR_PAGE_HTML_GLOBAL = `
    <div class="gen-page">
      ...
      <div class="gen-lightbox" id="gen-lightbox">
        <div class="gen-lightbox-backdrop"></div>
        <img class="gen-lightbox-img" id="gen-lightbox-img" src="" alt="">
        <button class="gen-lightbox-close" id="gen-lightbox-close" aria-label="Close">&times;</button>
      </div>
        ...
        <div class="gen-hero-row">
          ...
          <div class="gen-hero-cards">
            <div class="gen-card-stack" id="gen-card-stack">
              <img class="gen-stack-card" data-index="0" src="screenshots/generator/card-cover.JPG" alt="Cover card" loading="lazy">
              <img class="gen-stack-card" data-index="1" src="screenshots/generator/card-text.JPG" alt="Text card" loading="lazy">
              <img class="gen-stack-card" data-index="2" src="screenshots/generator/card-list.JPG" alt="List card" loading="lazy">
              <img class="gen-stack-card" data-index="3" src="screenshots/generator/card-terminal.JPG" alt="Terminal card" loading="lazy">
              <img class="gen-stack-card" data-index="4" src="screenshots/generator/card-grid.JPG" alt="Grid card" loading="lazy">
            </div>
          </div>
        </div>
      </section>
      ...
      <!-- ═══ SECTION 2: HOW IT WORKS (horizontal alternating) ═══ -->
      <section class="gen-section" id="section-features">
        ...
        <div class="gen-step-row gen-step-left">
          <div class="gen-step-visual">
            <img src="screenshots/generator/input.png" alt="Input interface" loading="lazy">
          </div>
          <div class="gen-step-text-block">
            <span class="gen-step-num">01</span>
            <h3 class="lang-zh">输入灵感</h3>
            <h3 class="lang-en">Input Your Idea</h3>
            <p class="lang-zh">写下想法，选择创作风格，贴上参考链接。AI 会根据你的输入和风格偏好，开始构思内容。</p>
            <p class="lang-en">Write your idea, pick a style, add reference links. AI begins crafting content based on your input.</p>
          </div>
        </div>

        <div class="gen-divider-thin"></div>

        <div class="gen-step-row gen-step-right">
          <div class="gen-step-text-block">
            <span class="gen-step-num">02</span>
            <h3 class="lang-zh">AI 生成卡片</h3>
            <h3 class="lang-en">AI Generates</h3>
            <p class="lang-zh">AI 一次性生成全套卡片，五种布局自动编排。从封面到正文，每张卡片都经过精心排版。</p>
            <p class="lang-en">AI generates a full set of cards with five layouts. From cover to content, each card is beautifully typeset.</p>
          </div>
          <div class="gen-step-visual">
        ...
        <div class="gen-step-row gen-step-left">
          ...
          <div class="gen-step-text-block">
            ...
            <p class="lang-zh">点击文字直接修改，AI 辅助局部改写。选中文字说"更犀利"，AI 立刻重写选中部分。</p>
            <p class="lang-en">Click any text to edit, AI helps rewrite selections. Select text and say "sharper" — AI rewrites instantly.</p>
          </div>
        </div>
        ...
        <div class="gen-step-row gen-step-right">
          <div class="gen-step-text-block">
            ...
            <p class="lang-zh">1242×1660px 标准尺寸，批量导出 PNG。直接上传到小红书，无需二次裁剪。</p>
            <p class="lang-en">Export all cards as PNG at 1242×1660px. Upload directly to Xiaohongshu — no cropping needed.</p>
          </div>
          <div class="gen-step-visual">
      ...
      <!-- ═══ SECTION 3: CARD LAYOUTS (alternating like AI Power) ═══ -->
      <section class="gen-section" id="section-tech">
        ...
        <div class="gen-layout-showcase gen-showcase-left">
          <div class="gen-showcase-text">
            <span class="gen-step-num">01</span>
            <h3>Cover</h3>
            <p class="lang-zh">封面卡片 — 大标题 + 双图堆叠 + 装饰星星 + 品牌标签。第一眼就抓住读者。</p>
            <p class="lang-en">Cover card — headline + stacked dual images + decorative stars + brand badges. Hook readers at first glance.</p>
          </div>
          <div class="gen-showcase-image">
        ...
        <div class="gen-layout-showcase gen-showcase-right">
          <div class="gen-showcase-text">
            <span class="gen-step-num">02</span>
            <h3>Text</h3>
            <p class="lang-zh">纯文本卡片 — 荧光笔高亮 + 标签标记 + 图文混排。适合干货长文。</p>
            <p class="lang-en">Text card — highlight markers + inline tags + mixed text-image blocks. Perfect for in-depth content.</p>
          </div>
          <div class="gen-showcase-image">
        ...
        <div class="gen-layout-showcase gen-showcase-left">
          <div class="gen-showcase-text">
            <span class="gen-step-num">03</span>
            <h3>List</h3>
            <p class="lang-zh">列表卡片 — 自动编号圆形标记，适合步骤型内容。清单、教程的最佳选择。</p>
            <p class="lang-en">List card — auto-numbered circular markers. Best for checklists, tutorials, and step-by-step guides.</p>
          </div>
          <div class="gen-showcase-image">
        ...
        <div class="gen-layout-showcase gen-showcase-right">
          <div class="gen-showcase-text">
            <span class="gen-step-num">04</span>
            <h3>Terminal</h3>
            <p class="lang-zh">终端卡片 — 仿 macOS 终端窗口，Catppuccin Mocha 配色。极客风满满。</p>
            <p class="lang-en">Terminal card — macOS-style terminal with Catppuccin Mocha color scheme. For the hacker aesthetic.</p>
          </div>
          <div class="gen-showcase-image">
        ...
        <div class="gen-layout-showcase gen-showcase-left">
          <div class="gen-showcase-text">
            ...
            <h3>Grid</h3>
            <p class="lang-zh">网格卡片 — 2 列布局，蓝色等宽字体，适合展示工具集合和资源列表。</p>
            <p class="lang-en">Grid card — 2-column grid with monospace labels. Perfect for tool collections and resource lists.</p>
          </div>
          <div class="gen-showcase-image">
